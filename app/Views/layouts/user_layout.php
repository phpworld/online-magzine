          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="#" aria-expanded="false">
                ...
                <span class="hide-menu">Magazines Library</span>
              </a>
            </li>
			<li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('/my_magzines/') ?>" aria-expanded="false">
                ...
                <span class="hide-menu">My Magazines</span>
              </a>
            </li>
			
			<li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('user/payment_history') ?>" aria-expanded="false">
                <span>
